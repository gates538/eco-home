...
[![Versione](https://img.shields.io/badge/versione-1.1.6-2ea44f?style=flat-square)](eco-home-v1.1.6.yaml)
[![Formato](https://img.shields.io/badge/formato-YAML-CB171E?style=flat-square&logo=yaml&logoColor=white)](eco-home-v1.1.6.yaml)
...
3. Installa [eco-home-v1.1.6-helpers.yaml](eco-home-v1.1.6-helpers.yaml) come package oppure segui [GUIDA_HELPER_UI.md](GUIDA_HELPER_UI.md).
4. Copia [eco-home-v1.1.6.yaml](eco-home-v1.1.6.yaml) in `automations.yaml`.
...
| File | Contenuto |
|---|---|
| [eco-home-v1.1.6.yaml](eco-home-v1.1.6.yaml) | Automazione standalone |
| [eco-home-v1.1.6-dashboard-card.yaml](eco-home-v1.1.6-dashboard-card.yaml) | Card Lovelace completa |
| [eco-home-v1.1.6-helpers.yaml](eco-home-v1.1.6-helpers.yaml) | Package completo degli helper |
| [eco-home-v1.1.6-dashboard-tuttacasa.yaml](eco-home-v1.1.6-dashboard-tuttacasa.yaml) | Plancia completa "Tutta Casa" |
...
Per nuove installazioni usa sempre i file `v1.1.6` nella cartella principale.
