...
[![Versione](https://img.shields.io/badge/versione-1.1.7-2ea44f?style=flat-square)](eco-home-v1.1.7.yaml)
[![Formato](https://img.shields.io/badge/formato-YAML-CB171E?style=flat-square&logo=yaml&logoColor=white)](eco-home-v1.1.7.yaml)

</div>

## Novità della versione 1.1.7
...
- Aggiornati tutti i file di configurazione, card e documentazione alla release 1.1.5.
...
3. Installa [eco-home-v1.1.7-helpers.yaml](eco-home-v1.1.7-helpers.yaml) come package oppure segui [GUIDA_HELPER_UI.md](GUIDA_HELPER_UI.md).
4. Copia [eco-home-v1.1.7.yaml](eco-home-v1.1.7.yaml) in `automations.yaml`.
...
## Aggiornamento dalla 1.1.4 o precedente
...
| File | Contenuto |
|---|---|
| [eco-home-v1.1.7.yaml](eco-home-v1.1.7.yaml) | Automazione standalone |
| [eco-home-v1.1.7-dashboard-card.yaml](eco-home-v1.1.7-dashboard-card.yaml) | Card Lovelace completa |
| [eco-home-v1.1.7-helpers.yaml](eco-home-v1.1.7-helpers.yaml) | Package completo degli helper |
| [eco-home-v1.1.7-dashboard-tuttacasa.yaml](eco-home-v1.1.7-dashboard-tuttacasa.yaml) | Plancia completa "Tutta Casa" |
...
- [Eco Home v1.1.6](archive/v1.1.6)
- [Eco Home v1.1.5](archive/v1.1.5)
- [Eco Home v1.1.4](archive/v1.1.4)
- [Eco Home v1.1.3](archive/v1.1.3)
- [Eco Home v1.1.2](archive/v1.1.2)
- [Eco Home v1.1.1](archive/v1.1.1)

Per nuove installazioni usa sempre i file `v1.1.7` nella cartella principale.
